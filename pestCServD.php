...
<div class="">
        ...
        <img src="img/pest.jpg" class="mx-auto d-block aboutimg"><br>
        <p class="cs1" style="color: #FFFFFF">M&R Service Pest Control service has the specialists and the experience necessary to keep you in compliance. We provide services to various commercial premises like Pharmaceutical factories, Food Processing plant, Garments Industries, Telecommunication switch, School etc with the level of quality service you expect. Our high-quality and professional group is based on a team of experts insect pest control service meets your high-quality standards and norms. Quality assurance program team alwase check every step and ensure guarantees in service all over the Bangladesh.
       </p>
<br>
       <h2 class="cs1" style="color: #FFFFFF"><b>What’s included in our pest control service?</b></h2>
<br>
       <ul class="cs1" style="color: #FFFFFF">
       <li>Termite Control</li>
       <li>Rodent Control</li>
       <li>Coackroach Control</li>
