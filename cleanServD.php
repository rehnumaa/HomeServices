...
<script>
           ...
           var service_pie_chart = new CanvasJS.Chart("piechartContainer_eq", {
                         theme: "dark2",
                         exportEnabled: true,
...
<div class="">
        ...
        <img src="img/clean.jpg" class="mx-auto d-block aboutimg"><br>
        <p class="cs1" style="color: #FFFFFF">If you haven’t had your home professionally cleaned within the past three months or you don’t use a cleaning service on a regular basis, your home definitely needs a deep clean. This is why our cleaning service in Bangladesh is recommended if you’re scheduling your first appointment. Our cleaning service includes all the services of a standard clean, but with special attention to the areas you may have forgotten to clean over time, getting your home squeaky clean. Our cleaning professionals know exactly where to focus their efforts on, whether it be under your bed or that corner that you haven’t attempted to clean in months. We prepare your home for easier cleanings in the future.
       </p>
<br>
       <h2 class="cs1" style="color: #FFFFFF"><b>What’s included in our cleaning service?</b></h2>
<br>
       <ul class="cs1" style="color: #FFFFFF">
       <li>Cleaning interior windows</li>
       <li>Cleaning interior walls</li>
       <li>Cleaning inside cabinets and drawers</li>
       <li>Cleaning inside the fridge</li>
       <li>Cleaning inside the oven, microwave & other appliances</li>
       </ul>
